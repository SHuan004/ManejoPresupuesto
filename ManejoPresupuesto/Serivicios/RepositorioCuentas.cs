...
namespace ManejoPresupuesto.Serivicios
{
    ...
    public class RepositorioCuentas: IRepositorioCuentas
    {
        ...
        public async Task<Cuenta> ObetenerPorId(int id,int usuarioId)
        {
            ...
            return await connection.QueryFirstOrDefaultAsync<Cuenta>(@"SELECT Cuentas.Id , Cuentas.Nombre, Cuentas.Balance,Cuentas.Descripcion, TipoCuentaId                                                                    FROM Cuentas 
                                                                    INNER JOIN TiposCuentas tc 
                                                                    ON tc.Id = Cuentas.TipoCuentaId
