...
namespace ManejoPresupuesto.Controllers
{
    ...
    public class TransaccionesController : Controller
    {
        ...
        public async Task<IActionResult> Index(int mes, int año)
        {
            ...
            var modelo = await servicioReportes.ObtRepTransDet(usuarioId,mes,año,ViewBag);
        ...
        public async Task<FileResult> ExportarExcelPorMes(int mes,int año)
        {
            ...
            var transacciones = await repositorioTransacciones.ObtenerPorUsuarioId(new ParaObTransacPorUsuario()
            {
                FechaFin = fechaFin,
                FechaInicio = fechaInicio,
                UsuarioId = usuarioId
        ...
        public async Task<FileResult> ExportarExcelTodo()
        {
            ...
            var fechaFin = DateTime.Today.AddYears(+200);
        ...
        public async Task<IActionResult> Crear(TransaccionCreacionViewModel modelo)
        {
            ...
            var cuenta = await repositorioCuentas.ObetenerPorId(modelo.CuentaId,usuarioId);
        ...
        public async Task<IActionResult> Editar(int id, string urlRetorno = null)
        {
            ...
            modelo.CuentAnteriorId = transaccion.CuentaId;
        ...
        public async Task<IActionResult> Editar(TransaccionActualizacionViewModel modelo)
        {
            ...
            await repositorioTransacciones.Actualizar(transaccion, modelo.MontoAnterior,modelo.CuentAnteriorId);
        ...
        private async Task<IEnumerable<SelectListItem>> ObtenerCategorias(int usuarioId, TipoOperacion tipoOperacion)
        {
            ...
            var resultado = categoria.Select(x => new SelectListItem(x.Nombre, x.Id.ToString())).ToList();
